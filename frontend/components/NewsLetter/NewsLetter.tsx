...
const newsletterSectionClasses = {
  container: "px-4 py-[100px] md:px-36 text-white",
  heading: "text-2xl md:text-4xl font-bold mb-3 md:mb-5 text-black",
  subHeading: "text-base md:text-lg mb-6 md:mb-10 text-black",
  cardContainer:
  ...
  cardSubHeading: "text-sm md:text-base text-gray-300 mb-4 text-white",
  formContainer:
  ...
  button:
    "bg-white text-black font-bold py-3 px-8 rounded-b-lg md:rounded-r-lg transition-all duration-200 md:ml-4 mt-4 md:mt-0",
};
